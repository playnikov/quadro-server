    ...
    companion object {
        fun fromEnvironment(): AppConfig {
            return AppConfig(
                ...
                server = ServerConfig(
                    domain = (System.getenv("HOST") ?: "localhost"),
                    port = (System.getenv("PORT") ?: "8082").toInt()
                ),
                database = DatabaseConfig(
                    host = System.getenv("DB_HOST") ?: "localhost",
                    port = (System.getenv("DB_PORT") ?: "5432").toInt(),
                    name = System.getenv("DB_NAME") ?: "company_db",
                    schema = System.getenv("DB_SCHEMA") ?: "company_schema",
                ...
                jwt = JwtConfig(
                    ...
                    invitationExpiration = (System.getenv("JWT_REFRESH_EXPIRATION") ?: "604800000").toLong(),
                    ),
                minio = MinioConfig(
...
data class ServerConfig(val domain: String, val port: Int)

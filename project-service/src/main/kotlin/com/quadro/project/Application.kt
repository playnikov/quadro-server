...
import com.quadro.project.di.kafkaModule
import com.quadro.project.di.projectModules
...
fun main(args: Array<String>) {
    ...
    try {
        ...
        logger.error("Failed to start Project Service", e)
        exitProcess(1)
    }
}
...
fun Application.module() {
    install(Koin) {
        slf4jLogger()
        modules(
            sharedModule(this@module, "project-service"),
            projectModules,
            kafkaModule
        )
    }
